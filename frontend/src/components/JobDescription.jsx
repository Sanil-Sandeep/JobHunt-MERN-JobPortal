...
const JobDescription = () => {
    ...
    const isIntialyApplied = singleJob?.applications?.some(application=>application.applicant == user?._id) || false;
    const [isApplied, setIsApplied] = useState(isIntialyApplied);
        ...
        <div className='flex items-center justify-between'>
            <div>
                ...
                <div className='flex items-center gap-2 mt-4'>
                    ...
                    <Badge className={'text-[#7209B7] font-bold'} variant="ghost">Rs {singleJob?.salary}</Badge>
                </div>
            </div>
            <Button 
